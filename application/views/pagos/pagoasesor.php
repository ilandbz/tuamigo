<div class="container">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h3 class="panel-title">HABILITAR CUENTA ASESOR</h3>
		</div>
		<div class="panel-body">
	<form action="<?php echo base_url() ?>index.php/pagos/grdsaldoasesor" class="form-horizontal" method="POST" onsubmit="return checkSubmit()">
	...
	<form action="<?php echo base_url() ?>index.php/pagos/actualizarsaldos" name="actualizarsaldosasesor" method="POST">
		...
		<table class="table table-striped">
			<tr>
				...
				<th>DNI</th>
				<th width="30%">SALDO
				 <?php //echo time() <= strtotime("18:30:00") ? '' : 'disabled' ?>
			...
			foreach($pagoasesor as $row) : 
				$total=$total+(is_null($row['saldocredito']) ? '0.00' : $row['saldocredito']);
			?>
			<tr>
				...
				<td>
					...
					<div class="input-group col-md-8">
						...
						<input type="text" class="form-control numerosypunto" name="saldoasesor[<?php echo $row['codusuario'] ?>][saldo]" value="<?php echo (is_null($row['saldocredito']) ? '0.00' : $row['saldocredito']) ?>">
