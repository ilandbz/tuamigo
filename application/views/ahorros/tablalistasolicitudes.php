<table class="table table-bordered table-condensed table-striped small">
	...
	<tr>
		...
		<td><a title="Generar Calendario" target="_blank" href="<?php echo base_url() ?>index.php/ahorros/pagoform/<?php echo $row['codigo'] ?>" class="btn btn-block"><span class="glyphicon glyphicon-edit"></span></a></td>
	</tr>
	<?php endforeach; ?>
	<tr>
