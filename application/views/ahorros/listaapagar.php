			...
			<tr>
				...
				<td align="center">
					<div class="btn-group btn-group-xs">
						<a title="Plan de Pagos" href="<?php echo base_url() ?>index.php/ahorros/plandepagosopdf/<?php echo $row['codigo'] ?>" target="_blank" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span></a>	
						<a title="Kardex de Pagos" href="<?php echo base_url() ?>index.php/ahorros/kardexpdf/<?php echo $row['codigo'] ?>" target="_blank" class="btn btn-default"><span class="glyphicon glyphicon-check"></span></a>
					</div>
				</td>
			</tr>
			<?php endforeach; ?>
