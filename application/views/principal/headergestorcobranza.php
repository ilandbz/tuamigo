  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class=""><a href="<?php echo base_url() ?>index.php/report">Posicion Cliente</span></a></li>        
        <li class=""><a href="<?php echo base_url() ?>index.php/castigo">Cobranza</span></a></li>
        <li class=""><a href="<?php echo base_url() ?>index.php/castigo/riesgo">Mayor a 8</span></a></li>
      </ul>
