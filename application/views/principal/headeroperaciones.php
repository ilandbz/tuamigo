...
<!--             <li><a href="<?php echo base_url() ?>index.php/cliente/crearpersonaform">Crear Persona</a></li> -->
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Caja Bancos <span class="caret"></span></a>
          <ul class="dropdown-menu">
          <li><a href="<?php echo base_url() ?>index.php/caja/cajabancosoperaciones">SALDO</a></li>
            <li><a href="<?php echo base_url() ?>index.php/caja/transferencia">TRANSFERENCIA</a></li>
            <li><a href="<?php echo base_url() ?>index.php/caja/formcuadrarcajadia">CUADRAR CAJA</a></li>
          </ul>           
        </li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Centro Costos <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <!-- <li><a href="<?php echo base_url() ?>index.php/Rrhh">Recursos Humanos</a></li>    -->        
          </ul>           
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">     
            ...
            <li><a href="<?php echo base_url() ?>index.php/caja/reportcajareal">Historia Caja</a></li>
            <li><a href="<?php echo base_url() ?>index.php/facturador/formreport">Comprobantes</a></li>
            <li><a href="<?php echo base_url() ?>index.php/rrhh/reportpagosueldoform">Pagos Sueldo</a></li>
          </ul>           
        </li>
        <li class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="">Ag. : <?php echo $this->session->userdata('agencia') ?></a></li>
        <li class="dropdown">
