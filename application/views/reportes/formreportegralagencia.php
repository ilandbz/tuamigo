<div class="container-fluid">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h4>REPORTE GENERAL DE CREDITOS AGENCIA <?php echo $this->session->userdata('agencia') ?></h4>
		</div>
...
<!-- 				<div class="form-group">
					...
					<div class="col-md-2">
						<button type="button" class="btn btn-info btn-xs" id="bscapenomrgral"><span class="glyphicon glyphicon-search"></span></button>
					</div>
				</div> -->
			</form>
