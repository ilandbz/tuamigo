...
<table class="table table-striped table-bordered table-hover small table-wrapper-scroll-y my-custom-scrollbar">
<!-- <table class="table-wrapper-scroll-y my-custom-scrollbar"> -->
	...
	<tr>
		...
		<td width="22%"><?php echo substr($row['apenom'], 0, 28) ?></td>
		...
		<td><?php echo ($row['pagomora']*$row['costomora']) ?></td>
		<td width="5%"><?php echo $row['fuenterecursos']; ?></td>
	...
	$sumreporte['desgrav']=$sumreporte['desgrav']+round($row['seguro'],1);	
	endforeach ; } 
	?>
    </tbody>
	<thead>
		<tr class="success">
			...
			<th width="5%">&nbsp;</th>
			<th width="5%">&nbsp;</th>
			<th width="22%" align="right">TOTAL</th>
			...
			<th width="8%">S/.<?php echo number_format(round($sumreporte['morapagado'],1),2) ?></th>
			<th width="5%"></th>
			...
			<th>S/.<?php echo number_format(round($sumreporte['desgrav'],1),2) ?></th>
			<th width="6%">&nbsp;</th>
...
<table id="reportegral" class="hidden" style="font-size:8px;">
	...
	<tr>
		...
		<td><?php echo $row['fuenterecursos']; ?></td>
	</tr>
	<?php $i++; endforeach; } ?>
	<tr class="success">
		<td></td>
		...
		<td width="8%">S/.<?php echo number_format(round($sumreporte['morapagado'],1),2) ?></td>
		...
		<td><?php echo number_format(round($sumreporte['desgrav'],1),2) ?></td>
		<td></td>
		<td></td>
	</tr>
</table>