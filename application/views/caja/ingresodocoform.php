<div class="container">
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title">INGRESO DOCO</h3>
		</div>
		<div class="panel-body">
			<form action="<?php echo base_url() ?>index.php/caja/regingresodoco" class="form-horizontal" method="POST" onsubmit="return checkSubmit()">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group">
							<span class="input-group-addon">ING. DOCO : </span>
